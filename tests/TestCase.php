...
namespace Mangopixel\Tracker\Tests;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\Relation;
use Illuminate\Database\Schema\Blueprint;
use Illuminate\Support\Facades\Schema;
use Mangopixel\Tracker\Trackable;
use Mangopixel\Tracker\TrackChanges;
use Mangopixel\Tracker\TrackerServiceProvider;
...
abstract class TestCase extends BaseTestCase
{
    ...
    {
        $model = new class extends Model implements Trackable
        {
            use TrackChanges;
